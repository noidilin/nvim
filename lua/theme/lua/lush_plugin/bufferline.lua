...
return lush(function()
	return {
		...
		BufferLineModifiedSelected { fg = p.accDim02, bg = p.mono02, gui = "bold italic" },
		...
		BufferLineHintSelected { fg = p.accDim05, bg = p.mono02, gui = "bold italic" },
		BufferLineHintDiagnosticSelected { fg = p.accDim02, bg = p.mono02, gui = "bold italic" },
		...
		BufferLineModifiedVisible { fg = p.accDim02, bg = p.mono02 },
		...
		BufferLineHintVisible { fg = p.accDim02, bg = p.mono02 },
		...
		---- mini icon
		BufferLineMiniIconsAzureInactive { fg = p.accDim02, bg = p.mono02 },
